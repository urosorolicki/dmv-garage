...
export function Contact() {
  ...
  const inputClass =
    "w-full bg-transparent border border-border/50 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/40 focus:outline-none transition-all duration-200 focus:[border-color:var(--brand)] focus:[box-shadow:0_0_0_1px_var(--brand-subtle)]"
      ...
      <div className="relative z-10 max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="font-display text-5xl md:text-6xl lg:text-7xl text-foreground tracking-wide uppercase mb-6">
              Zakažite termin
            </h2>
            ...
            <div className="flex flex-col gap-6">
              {/* Phone */}
              <div>
                <p className="text-xs tracking-[0.3em] uppercase mb-1 font-mono" style={{ color: "var(--brand)" }}>
                  Telefon
                </p>
                <a
                  href="tel:+381628727274"
                  className="text-xl font-sans font-light text-foreground hover:opacity-70 transition-opacity duration-300 font-mono"
                >
                  062 872 7274
                </a>
              </div>
              ...
              <div>
                ...
                <a
                  ...
                  className="text-xl font-sans font-light text-foreground hover:opacity-70 transition-opacity duration-300"
                >
                  @dmv__garage
                </a>
              </div>
          ...
          >
            {submitted ? (
              ...
              <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-5">
                ...
                <button
                  type="submit"
                  className="inline-flex items-center justify-center gap-3 px-8 py-4 text-sm tracking-[0.1em] uppercase font-medium transition-all duration-300 w-fit hover:opacity-85"
